...
class APJFMF_entity(nn.Module):
    def __init__(self, feature_columns, hidden_units, dnn_dropout=0.):
        ...
        dnn_dropout:失活率
        """
        super(APJFMF_entity, self).__init__()
...
class APJFMF_connect(nn.Module):
    def __init__(self, lstm_dim, lstm_hd_size, num_lstm_layers, vec_size_2, dropout, feature_columns, hidden_units, dnn_dropout):
        ...
        self.text_layer = APJFMF_text(lstm_dim, lstm_hd_size, num_lstm_layers, dropout)
        self.entity_layer = APJFMF_entity(feature_columns, hidden_units, dnn_dropout)
...
# batch_size = 4012
batch_size = 32
model_dir = 'APJFMF' # change with your model save path
...
test_acc, test_auc, test_precision, test_recall, test_f1 = testing(
    torch.load('APJFMF.model'), test_loader)
